...
(function() {
  ...
  StormObject = (function(superClass) {
    ...
    function StormObject(data, opts1, container) {
      var StormConstructor, StormType, key, ref, ref1;
      ...
      for (key in ref) {
        ...
        StormType = (function() {
          switch (StormConstructor.get('storm')) {
            case 'object':
              return StormConstructor.get('data');
            default:
              return StormConstructor.get('type');
          }
        })();
        this.addProperty(key, new StormConstructor(StormType, StormConstructor.get('opts'), this));
      }
